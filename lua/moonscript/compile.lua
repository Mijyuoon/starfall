...
do
  local _obj_0 = loadmodule("moonscript.transform.names")
  NameProxy, LocalName = _obj_0.NameProxy, _obj_0.LocalName
end
local Set
do
  local _obj_0 = loadmodule("moonscript.data")
  Set = _obj_0.Set
end
...
local statement_compilers = loadmodule("moonscript.compile.statement")
local value_compilers = loadmodule("moonscript.compile.value")
local concat, insert
do
  local _obj_0 = table
